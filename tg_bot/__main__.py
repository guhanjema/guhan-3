    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(DEVIL_IMG,PM_START_TEXT.format(escape_markdown(first_name), escape_markdown(bot.first_name), OWNER_NAME, OWNER_USERNAME ),reply_markup=InlineKeyboardMarkup(
                                                  [[InlineKeyboardButton(text="♻️Stream Channel",url="https://t.me/joinchat/fsaUd25r9z5jYmZl"),InlineKeyboardButton(text="📺TV Series Channel",url="https://t.me/TVSeries_TT")],
                                                [InlineKeyboardButton(text="🎬Tamil Tentkotta Group",url="https://t.me/Tentkottagroup"),InlineKeyboardButton(text="💠HEVC Channel",url="https://t.me/TT_Hevc")]]),disable_web_page_preview=True, parse_mode=ParseMode.MARKDOWN)
    else:
